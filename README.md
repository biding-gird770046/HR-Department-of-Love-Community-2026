...
# 🎮 HR Department of Love — Community Edition

**Office romance visual novel in a standalone community build.**
...
HR Department of Love is an indie visual novel set in a bustling corporate office, where daily paperwork and workplace incidents become the backdrop for budding romance. Players navigate dialogue choices, build relationships with a cast of distinct colleagues, and steer the story toward multiple endings. This Community Edition is a self-contained package that runs fully offline with no additional software required, and includes all content in a single install.

Players who enjoy story-driven romance visual novels and want an offline, ready-to-play office simulation experience.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4207080/ba7c11c00058bdf75ae61e86448384167beb20e2/ss_ba7c11c00058bdf75ae61e86448384167beb20e2.1920x1080.jpg?t=1786691019" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4207080/f84cf561d987ef6ee52f4b11c692fb12a12d5f93/ss_f84cf561d987ef6ee52f4b11c692fb12a12d5f93.1920x1080.jpg?t=1786691019" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4207080/86117e45ec39c6d5738885013e043d441bb983cf/ss_86117e45ec39c6d5738885013e043d441bb983cf.1920x1080.jpg?t=1786691019" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 📖 **Branching Storyline** — Dialogue choices shape relationships and lead to different narrative outcomes.
- 💘 **Romance Routes** — Pursue connections with several distinct characters across the office.
- 🏢 **Office Setting** — A workplace simulation backdrop blends comedy, drama, and daily office life.
- 🎭 **Multiple Endings** — Player decisions determine which finale the story reaches.
- 💾 **Self-Contained Package** — All files included in one install; no additional software required.
- 🔌 **Offline Play** — Runs entirely offline after installation, with no storefront required.
- 🖱️ **Point-and-Click Interface** — Simple, accessible controls suited to visual novel gameplay.
- 🎨 **Stylized Art** — Hand-drawn character portraits and illustrated event scenes.
- 🔊 **Voice and Soundtrack** — English voice work accompanied by an original music score.
- 🌐 **Multilingual Interface** — Community localization options available through fan translations.
...
- None — all content included in the base build
...
| **RAM** | 2 GB | 4 GB |
| **Graphics** | Integrated graphics, DirectX 11 compatible | Dedicated GPU with 1 GB VRAM |
| **Storage** | 2 GB available space | 2 GB available space on SSD |
| **Additional** | Mouse and keyboard | Headphones for the full audio experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\HRDepartmentofLove\Saved`
